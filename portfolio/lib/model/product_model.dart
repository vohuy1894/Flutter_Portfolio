...
class Product extends Equatable{
  ...
  String productId;
  int? productQuantity;
   Product({required this.name, required this.price, required this.imageUrl, required this.description, required this.category, required this.productId,  this.productQuantity});
  @override
